...
- No domain logic, scheduler logic, task execution endpoints, upload/storage endpoint, queue integration, import review API, live execution state, export generation, Project write-back, React app, mobile PWA, secrets, binaries, seed data, or real Project files have been added yet.
