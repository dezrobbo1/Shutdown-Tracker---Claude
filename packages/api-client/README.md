...
The client does not fetch data by itself, persist state, call MPXJ, parse uploaded files, generate files, implement auth, run offline sync, or write back to Microsoft Project.
